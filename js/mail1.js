...
var contactFormDB = firebase.database().ref("plugins");

document.getElementById("plugins").addEventListener("submit", submitForm);
...
function submitForm(e) {
  ...
  document.getElementById("plugins").reset();
